...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="FocusOnInput()">
        ...
        if(isset($_POST["submitRegister"])){
            ...
            $sql_check_ExistSubject=mysqli_query($conn, "select * from sessions_long where subject_id='".$_POST['subjectNumber']."'");
            $num_ExistSubject=mysqli_num_rows($sql_check_ExistSubject);
            if($num_ExistSubject==0){
                ...
                $sql_Register=mysqli_query($conn, "insert into sessions_long(subject_id,subject_name,subject_surname,age,sex,mind_condition,education_level,pc_usage,device_info,question_ids_sequence,current_question_index,current_block_number,completed,start_time) values('".$_POST['subjectNumber']."','".$_POST['subjectFirstname']."','".$_POST['subjectLastname']."','".$_POST['subjectAge']."','".$_POST['subjectSex']."','".$_POST['subjectCondition']."','".$_POST['subjectEducation']."','".$_POST['subjectPcusage']."','".$devices."','".$string_Sequence."','0','0','0','". $date_CreateSession."')");
                if($sql_Register){
                ...
                echo "<script>alert('Questo soggetto ha gia concluso lesperimento.');location='index.php';</script>";
                mysqli_close($conn);
            }          
        } 
        else{
